...
const char SUCCESSFULLY_INSTALLED_MSG[] = "OPL3Synth synth MIDI Driver successfully installed";
const char SUCCESSFULLY_UPDATED_MSG[] = "OPL3Synth synth MIDI Driver successfully updated";
const char SUCCESSFULLY_UNINSTALLED_MSG[] = "OPL3Synth synth MIDI Driver successfully uninstalled";
...
const char CANNOT_INSTALL_NO_PORTS_ERR[] = "Cannot install OPL3Synth synth MIDI driver:\n There is no MIDI ports available";
const char CANNOT_REGISTER_ERR[] = "Cannot register driver";
const char CANNOT_UNINSTALL_ERR[] = "Cannot uninstall OPL3Synth synth MIDI driver";
const char CANNOT_UNINSTALL_NOT_FOUND_ERR[] = "Cannot uninstall OPL3Synth synth MIDI driver:\n There is no driver registry entry found";
const char CANNOT_INSTALL_PATH_TOO_LONG_ERR[] = "OPL3Synth synth MIDI Driver cannot be installed:\n Installation path is too long";
const char CANNOT_INSTALL_FILE_COPY_ERR[] = "OPL3Synth synth MIDI Driver failed to install:\n File copying error";
